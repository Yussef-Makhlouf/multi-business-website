...
export default function HomePage() {
  ...
  <ServiceBanner
     ...
     <FeaturedBanner
        ...
        title="القوس الماسي"
        subtitle="للمقاولات في الحلول المتكاملة"
        description="نفخر بتقديم خدمات متميزة ومتكاملة في ثلاثة مجالات حيوية: تنظيف وتعقيم مجاري الهواء لأنظمة التكييف المركزي، والمقاولات، والدعاية والإعلان والتسويق للغير. خبرة سعودية رائدة من قلب مدينة جدة لخدمة المملكة العربية السعودية بأعلى معايير الجودة والاحترافية والابتكار."
        features={[
          "الدعاية والإعلان والتسويق للغير",
          "المقاولات العامة والتسويق العقاري",
          "تنظيف وتعقيم مجاري الهواء للمكيفات المركزية",
